...
public class JDBIOptionalLocalDateTimeTest {
    ...
    public void testPresent() {
        final Optional<LocalDateTime> endDate = Optional.of(LocalDateTime.parse("2015-11-03T10:15:30.00"));
        dao.insert(1, Optional.of("John Hughes"), LocalDateTime.now(), endDate, Optional.<String>empty());
