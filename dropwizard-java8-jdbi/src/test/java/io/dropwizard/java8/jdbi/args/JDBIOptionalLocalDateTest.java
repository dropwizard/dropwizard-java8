...
public class JDBIOptionalLocalDateTest {
    ...
    public void testPresent() {
        final Optional<LocalDate> endDate = Optional.of(LocalDate.parse("2015-11-03"));
        dao.insert(1, Optional.of("John Hughes"), LocalDate.now(), endDate, Optional.<String>empty());
